...
pub(crate) fn build_client() -> (ChatClient, (Sender<Packet>, Receiver<Packet>), (Sender<SimControllerCommand>, Receiver<SimControllerCommand>), (Sender<SimControllerResponseWrapper>, Receiver<SimControllerResponseWrapper>)) {
    ...
    (chat_client, neighbor, controller_channel_commands, controller_channel_messages)
}